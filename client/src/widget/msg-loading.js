...
export default class MsgLoading extends Component {
    ...
    render(props,{}) {
        return (
            ...
            :
            <span className={styles.msg_loading} onClick={props.onResend} style={{
                cursor: 'pointer'
            }}>
                <svg width="20" height="20" 
                version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 491.236 491.236" style="enable-background:new 0 0 491.236 491.236;" xmlSpace="preserve">
